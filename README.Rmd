...
ggplot() + 
  geom_sf(data = land50, fill = "#ffebbe", color = NA) + 
  ...
  geom_sf(data = coast50, size = .5, color = '#44afe3') + 
  geom_sf(data = rivers50, size = .5, color = '#44afe3') + 
  geom_sf(data = lakes50, fill = '#44afe3', color = NA) + 
  geom_sf(data = boundary_lines_land50, size = .1, color = 'black') + 
